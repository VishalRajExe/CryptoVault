...
//        PaymentResponse res = walleteService.depositFunds(user,amount);
        ...
        notificationService.create(user, "DEPOSIT", "Deposited $" + amount + " to your wallet.", amount);
    ...
    public ResponseEntity<Wallet> addMoneyToWallet(
        ...
        if(status){
            ...
            notificationService.create(user, "DEPOSIT",
                    "Deposited $" + order.getAmount() + " via " + order.getPaymentMethod() + ".", order.getAmount());
        }
...
//    }
    ...
    public ResponseEntity<Wallet> walletToWalletTransfer(@RequestHeader("Authorization")String jwt,
        ...
        // BUGFIX: only the sender's side of a wallet-to-wallet transfer was ever
        // recorded, leaving the receiver with no transaction history entry for money
        // they received.
        WalletTransaction receiverTransaction=walletTransactionService.createTransaction(
                reciverWallet,
